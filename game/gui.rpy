...
## 用于游戏内文本的字体。
define gui.text_font = "Yang-Regular.TTF"

## 用于角色名称的字体。
define gui.name_text_font = "Yang-Regular.TTF"

## 用于游戏外文本的字体。
define gui.interface_text_font = "Yang-Regular.TTF"
...
define gui.textbox_yalign = 0.964
...
## 为“0.5”来放置到正中。
define gui.dialogue_xpos = 172
define gui.dialogue_ypos = 64

## 对话文本的最大宽度（以像素为单位）。
define gui.dialogue_width = 918
...
define gui.choice_button_width = 522
...
define config.thumbnail_height = 128
...
define gui.history_text_ypos = 25
define gui.history_text_width = 770
